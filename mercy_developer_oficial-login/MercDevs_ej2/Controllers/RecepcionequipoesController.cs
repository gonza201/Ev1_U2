...
namespace MercDevs_ej2.Controllers
{
    public class RecepcionequipoesController : Controller
    {
        ...
        {
            var mercydevsEjercicio2Context = _context.Recepcionequipos.Where(u =>u.IdCliente == id).Include(r => r.IdClienteNavigation).Include(r => r.IdServicioNavigation); ;
        ...
        public async Task<IActionResult> VerDetalleEquipoRecepcionado(int? id)
        {
            var mercydevsEjercicio2Context = _context.Recepcionequipos.Where(u => u.IdCliente == id).Include(r => r.IdClienteNavigation).Include(r => r.IdServicioNavigation); ;
            return View(await mercydevsEjercicio2Context.ToListAsync());
        }
